...
###########################################
#Center
set_property PACKAGE_PIN P16 [get_ports req]
...
# LEDs
###########################################
set_property PACKAGE_PIN T22 [get_ports acc[0]]
set_property IOSTANDARD LVCMOS33 [get_ports acc[0]]
set_property PACKAGE_PIN T21 [get_ports acc[1]]
...
# DIP Switches
###########################################
set_property PACKAGE_PIN F22 [get_ports plane[0]]
set_property IOSTANDARD LVCMOS18    [get_ports {plane[0]}]
set_property PACKAGE_PIN G22 [get_ports {plane[1]}]
set_property IOSTANDARD LVCMOS18    [get_ports {plane[1]}]
set_property PACKAGE_PIN H22 [get_ports plane[2]]
set_property IOSTANDARD LVCMOS18    [get_ports {plane[2]}]
