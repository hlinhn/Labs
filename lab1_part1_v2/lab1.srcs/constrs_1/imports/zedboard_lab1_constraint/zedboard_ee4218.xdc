...
# DIP Switches
###########################################
set_property PACKAGE_PIN F22 [get_ports dip0]
set_property IOSTANDARD LVCMOS18    [get_ports dip0]
set_property PACKAGE_PIN G22 [get_ports dip1]
set_property IOSTANDARD LVCMOS18    [get_ports dip1]
set_property PACKAGE_PIN H22 [get_ports dip2]
set_property IOSTANDARD LVCMOS18    [get_ports dip2]
set_property PACKAGE_PIN F21 [get_ports dip3]
